...
- 🔍 **Comprehensive Detection**: 100+ built-in security rules covering:
...
- 📁 **Recursive Scanning**: Scan entire project directories with any level of subdirectories
- 📊 **Multiple Output Formats**: Generate reports in JSON or Excel format
- 🎨 **Color-coded Results**: Easy-to-read terminal output with severity-based coloring
- ⚡ **Fast & Efficient**: Parallel processing for large codebases
- 🔧 **Flexible Filtering**: Filter by severity, category, or file patterns
- 📈 **Detailed Reports**: Get comprehensive statistics and insights
